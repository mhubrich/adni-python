...
def build_model(input_shape=(1, 10, 10, 10)):
    ...
    x = Convolution3D(256, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv4')(x)
    x = Dropout(do, name=name+'_dropout4')(x)
    x = Convolution3D(512, 2, 2, 2, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv5')(x)
