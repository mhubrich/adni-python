...
from cnn.keras.final_metaROI.model25 import build_model
...
path_checkpoints = '/home/mhubrich/checkpoints/adni/final_metaROI_single25_1_pSMC_CV' + fold
...
def load_data(scans, flip=False):
    ...
    X = np.zeros((nb_samples, 1, 5, 5, 5), dtype=np.float32)
    j = 4
    i = 0
    for c in classes:
