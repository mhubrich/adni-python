...
from cnn.keras.final_metaROI.model23 import build_model
...
path_checkpoints = '/home/mhubrich/checkpoints/adni/final_metaROI_single23_1_pSMC_CV' + fold
...
def load_data(scans, flip=False):
    ...
    X = np.zeros((nb_samples, 1, 10, 10, 10), dtype=np.float32)
    j = 2
    i = 0
    for c in classes:
