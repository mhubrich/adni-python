...
def build_model(input_shape=(1, 5, 5, 5)):
    ...
    x = Dense(128, activation='relu', W_regularizer=l2(0.0001), name=name+'_dense1')(x)
    x = Dropout(0.5, name=name+'_dropout3')(x)
    x = Dense(64, activation='relu', W_regularizer=l2(0.0001), name=name+'_dense2')(x)
    x = Dropout(0.5, name=name+'_dropout4')(x)
    x = Dense(32, activation='relu', W_regularizer=l2(0.0001), name=name+'_dense3')(x)
