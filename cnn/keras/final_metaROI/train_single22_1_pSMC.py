...
from cnn.keras.final_metaROI.model22 import build_model
...
path_checkpoints = '/home/mhubrich/checkpoints/adni/final_metaROI_single22_1_pSMC_CV' + fold
...
def load_data(scans, flip=False):
    ...
    X = np.zeros((nb_samples, 1, 6, 6, 6), dtype=np.float32)
    j = 1
    i = 0
    for c in classes:
