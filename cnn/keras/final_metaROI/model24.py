...
def build_model(input_shape=(1, 13, 13, 13)):
    ...
    x = Convolution3D(32, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv2')(x)
    ...
    x = Convolution3D(128, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv4')(x)
    ...
    x = Convolution3D(512, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv6')(x)
