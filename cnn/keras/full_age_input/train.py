...
from cnn.keras.models.AVG444.model_age_input import build_model
from cnn.keras.full_age_input.image_processing import inputs
...
path_checkpoints = '/home/mhubrich/checkpoints/adni/full_age_input_1_CV' + fold
path_weights = None
