...
path_checkpoints = '/home/mhubrich/checkpoints/adni/deepROI8_4_CV' + fold
...
def train():
    ...
    scans_train = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_deepROI8/' + fold + '_train')
    x_train_AD, y_train = load_data(scans_train)

    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_deepROI8/' + fold + '_val')
    ...
    cbks = [callbacks.print_history(),
            callbacks.flush(),
            Evaluation(x_val_AD, y_val, batch_size,
