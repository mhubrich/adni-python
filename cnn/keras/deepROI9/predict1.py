...
from cnn.keras.deepROI9.get_paths import get_paths
from cnn.keras.deepROI9.predict_iterator2 import ScanIterator
...
path_model = get_paths(n=1, k=10)


def predict():
    # Get inputs for training and validation
    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_mean2_rui/' + fold + '_val')
    ...
    with open('predictions_deepROI9_1_fliter_' + str(filter_length) + '_fold_' + fold + '.csv', 'wb') as csvfile:
