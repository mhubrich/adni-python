...
from cnn.keras.models.AVG222.model import build_model
from cnn.keras.AVG222.image_processing import inputs
...
num_epoch = 1000
# Paths
path_ADNI = '/home/mhubrich/ADNI_intnorm_avgpool222'
path_checkpoints = '/home/mhubrich/checkpoints/adni/AVG222_1_CV' + fold
path_weights = None
