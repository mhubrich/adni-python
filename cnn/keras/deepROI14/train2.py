...
path_checkpoints = '/home/mhubrich/checkpoints/adni/deepROI14_2_CV' + fold
...
def train():
    ...
    scans_train = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_norui/' + fold + '_train')
    scans_train += read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_norui/' + fold + '_val')
    scans_train += read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_norui/' + fold + '_test')
    ...
    model.save(path_checkpoints + '/model.h5')
