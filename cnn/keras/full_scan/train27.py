...
path_checkpoints = '/home/mhubrich/checkpoints/adni/full_scan_27_CV' + fold
...
def train():
    ...
    model = load_model('/home/mhubrich/checkpoints/adni/full_scan_27_CV7/model.0073-loss_0.511-acc_0.899-val_loss_0.1649-val_acc_0.9463-val_fmeasure_0.9437-val_mcc_0.8927-val_mean_acc_0.9469.h5')
