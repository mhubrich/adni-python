...
path_checkpoints = '/home/mhubrich/checkpoints/adni/full_scan_31_CV' + fold
    ...
    cbks = [callbacks.print_history(),
            ...
            Evaluation(x_val, y_val, batch_size,
                       [callbacks.early_stop(patience=60, monitor=['val_loss', 'val_acc', 'val_fmeasure', 'val_mcc', 'val_mean_acc']),
                        callbacks.save_model(path_checkpoints, max_files=2, monitor=['val_loss', 'val_acc', 'val_mean_acc'])])]
