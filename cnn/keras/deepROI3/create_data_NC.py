...
# Change both paths
directory = '/home/mhubrich/ADNI_intnorm_deepROI3_NC'
brain = np.load('/home/mhubrich/predicted_brain_NC_pn_threshold_02.npy')
...
for f in files:
    ...
    scan = scan[17:81,:,:][:,15:83,:][:,:,8:76]
    # Pool down by 4x4x4
    scan = block_reduce(scan, (4,4,4), func=np.mean, cval=0)
    # Pad with zeros (new dims: 17x17x17)
    scan = np.pad(scan, ((0,1), (0,0), (0,0)), 'constant', constant_values=0)
