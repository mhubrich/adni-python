...
path_checkpoints = '/home/mhubrich/checkpoints/adni/deepROI13_1_CV' + fold
...
def train():
    ...
    scans_train = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_deepROI13/' + fold + '_train')
    x_train, y_train = load_data(scans_train)

    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_deepROI13/' + fold + '_val')
