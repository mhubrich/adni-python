...
def build_model(input_shape=(1, 19, 19, 19)):
	...
	model.add(Flatten(name='mean4_flatten1'))
        ...
        model.add(Dense(256, activation='relu', W_regularizer=l2(0.0001), name='mean4_dense1'))
        model.add(Dropout(0.2, name='mean4_dropout7'))
        model.add(Dense(128, activation='relu', W_regularizer=l2(0.0001), name='mean4_dense2'))
        model.add(Dropout(0.2, name='mean4_dropout8'))
        model.add(Dense(2, activation='softmax', W_regularizer=l2(0.0001), name='mean4_dense3'))
