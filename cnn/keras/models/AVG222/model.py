...
def build_model(input_shape=(1, 44, 44, 44)):
	...
	model.add(Convolution3D(32, 11, 11, 11, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv1'))
        model.add(Dropout(do, name=name+'_dropout1'))
	model.add(Convolution3D(32, 9, 9, 9, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv2'))
        ...
        model.add(Convolution3D(64, 7, 7, 7, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv4'))
        model.add(Dropout(do, name=name+'_dropout4'))
	model.add(Convolution3D(128, 5, 5, 5, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv5'))
        ...
        model.add(Convolution3D(512, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv9'))
        model.add(Dropout(do, name=name+'_dropout9'))
        model.add(Convolution3D(512, 2, 2, 2, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv10'))
