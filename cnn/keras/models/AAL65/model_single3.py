...
def build_model(input_shape=(1, 21, 21, 21)):
	...
	model.add(Convolution3D(256, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name='AAL65_conv6'))
        model.add(Dropout(1.0/14, name='AAL65_dropout6'))
        model.add(Convolution3D(512, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name='AAL65_conv7'))
	...
	model.add(Flatten(name='AAL65_flatten1'))
        ...
        model.add(Dropout(0.2, name='AAL65_dropout8'))
        model.add(Dense(128, activation='relu', W_regularizer=l2(0.0001), name='AAL65_dense2'))
        model.add(Dropout(0.2, name='AAL65_dropout9'))
