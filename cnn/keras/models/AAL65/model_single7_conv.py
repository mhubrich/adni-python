...
def build_model(input_shape=(1, 21, 20, 18)):
	model = Sequential()
	...
	model.add(Convolution3D(32, 5, 5, 5, activation='relu', W_regularizer=l2(0.0001), name='AAL65_conv2'))
        ...
        model.add(Convolution3D(64, 5, 5, 3, activation='relu', W_regularizer=l2(0.0001), name='AAL65_conv3'))
	...
	model.add(Convolution3D(128, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name='AAL65_conv5'))
        ...
        model.add(Convolution3D(256, 3, 2, 2, activation='relu', W_regularizer=l2(0.0001), name='AAL65_conv7'))
