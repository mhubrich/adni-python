...
def build_model(input_shape=(1, 8, 12, 13)):
        name = 'AAL35'
        do = 1.0/4
	model = Sequential()
	...
	model.add(Convolution3D(32, 3, 5, 5, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv2'))
        ...
        model.add(Convolution3D(128, 2, 2, 3, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv4'))
