...
def build_model(input_shape=(1, 44, 52, 44)):
    ...
    model.add(Convolution3D(32, 5, 5, 5, activation='relu', border_mode='same', input_shape=input_shape))
    ...
    model.add(UpSampling3D(size=(2, 2, 2)))
    model.add(Convolution3D(1, 5, 5, 5, activation='relu', border_mode='same'))
