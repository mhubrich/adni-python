...
def build_model(input_shape=(1, 17, 17, 17)):
	...
	model.add(Flatten(name='mean1_flatten1'))
        ...
        model.add(Dense(256, activation='relu', W_regularizer=l2(0.0001), name='mean1_dense1'))
        model.add(Dropout(0.2, name='mean1_dropout7'))
        model.add(Dense(128, activation='relu', W_regularizer=l2(0.0001), name='mean1_dense2'))
        model.add(Dropout(0.2, name='mean1_dropout8'))
        model.add(Dense(2, activation='softmax', W_regularizer=l2(0.0001), name='mean1_dense3'))
