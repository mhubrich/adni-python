...
def build_model(input_shape=(1, 13, 13, 13)):
	...
	model.add(Flatten(name='ROI4_flatten1'))
        ...
        model.add(Dense(256, activation='relu', W_regularizer=l2(0.0001), name='ROI4_dense1'))
        model.add(Dropout(0.2, name='ROI4_dropout7'))
        model.add(Dense(128, activation='relu', W_regularizer=l2(0.0001), name='ROI4_dense2'))
        model.add(Dropout(0.2, name='ROI4_dropout8'))
        model.add(Dense(2, activation='softmax', W_regularizer=l2(0.0001), name='ROI4_dense3'))
