...
def build_model(input_shape=(1, 13, 13, 13)):
	...
	model.add(Convolution3D(64, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name='ROI4_conv2'))
        model.add(Dropout(0.1, name='ROI4_dropout2'))
        model.add(Convolution3D(128, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name='ROI4_conv3'))
        model.add(Dropout(0.1, name='ROI4_dropout3'))
        model.add(Convolution3D(256, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name='ROI4_conv4'))
        model.add(Dropout(0.1, name='ROI4_dropout4'))
	model.add(Convolution3D(512, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name='ROI4_conv5'))
        model.add(Dropout(0.1, name='ROI4_dropout5'))
	model.add(Convolution3D(1024, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name='ROI4_conv6'))
