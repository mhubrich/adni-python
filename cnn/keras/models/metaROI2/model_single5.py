...
def build_model(input_shape=(1, 6, 6, 6)):
	...
	model.add(Flatten(name='ROI2_flatten1'))
        ...
        model.add(Dense(512, activation='relu', W_regularizer=l2(0.0001), name='ROI2_dense1'))
        model.add(Dropout(0.5, name='ROI2_dropout3'))
        model.add(Dense(2, activation='softmax', W_regularizer=l2(0.0001), name='ROI2_dense2'))
