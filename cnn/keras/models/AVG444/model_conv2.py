...
def build_model(input_shape=(1, 22, 22, 22)):
    ...
    x = Convolution3D(32, 5, 5, 5, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv1')(x)
    ...
    x = Convolution3D(64, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name=name+'_conv3')(x)
    ...
    x = Dropout(0.2, name=name+'_dropout11')(x)
    x = Dense(128, activation='relu', W_regularizer=l2(0.0001), name=name+'_dense3')(x)
    x = Dropout(0.2, name=name+'_dropout12')(x)
