...
def build_model(input_shape=(1, 22, 22, 22)):
    ...
    output_p = Dense(1, activation='sigmoid', W_regularizer=l2(0.0001), name=name+'_dense4')(x)
    output_FAQ = Dense(1, activation='sigmoid', W_regularizer=l2(0.0001), name=name+'_dense5')(x)

    return Model(input=input, output=[output_p, output_FAQ])
