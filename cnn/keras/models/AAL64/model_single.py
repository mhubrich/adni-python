...
def build_model(input_shape=(1, 18, 18, 18)):
	...
	model.add(Convolution3D(256, 3, 3, 3, activation='relu', W_regularizer=l2(0.0001), name='AAL64_conv6'))
        model.add(Dropout(0.05, name='AAL64_dropout6'))
        model.add(Convolution3D(512, 2, 2, 2, activation='relu', W_regularizer=l2(0.0001), name='AAL64_conv7'))
	...
	model.add(Flatten(name='AAL64_flatten1'))
        ...
        model.add(Dropout(0.2, name='AAL64_dropout9'))
