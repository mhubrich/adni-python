...
path_checkpoints = '/home/mhubrich/checkpoints/adni/deepROI11_1_CV' + fold
...
def train():
    ...
    scans_train = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_deepROI10/' + fold + '_train')
    x_train, y_train = load_data(scans_train)

    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_deepROI10/' + fold + '_val')
    ...
    cbks = [callbacks.print_history(),
            ...
            Evaluation(x_val, y_val, batch_size,
                       [callbacks.early_stop(patience=90, monitor=['val_loss', 'val_acc', 'val_fmeasure', 'val_mcc', 'val_mean_acc']),
