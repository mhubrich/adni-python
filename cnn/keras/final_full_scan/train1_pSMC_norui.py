...
path_checkpoints = '/home/mhubrich/checkpoints/adni/final_full_scan_pSMC_norui_1_CV' + fold
...
def train():
    ...
    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_norui/' + fold + '_val')
