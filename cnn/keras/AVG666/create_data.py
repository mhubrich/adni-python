...
# Change both paths
directory = '/home/mhubrich/ADNI_intnorm_avgpool666'
...
for f in files:
    ...
    # Bring to size 88x90x88
    scan = np.delete(scan, range(9), 1)
    scan = np.delete(scan, range(90, 99), 1)
    # Pool down by 6x6x6
    scan = block_reduce(scan, (6,6,6), func=np.mean, cval=0)
