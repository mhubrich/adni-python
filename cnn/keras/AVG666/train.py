...
from cnn.keras.models.AVG666.model_normal import build_model
...
target_size = (15, 15, 15)
classes = ['Normal', 'AD']
batch_size = 64
num_epoch = 1000
# Paths
path_ADNI = '/home/mhubrich/ADNI_intnorm_avgpool666'
path_checkpoints = '/home/mhubrich/checkpoints/adni/AVG666_1_CV' + fold
