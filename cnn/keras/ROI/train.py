...
from cnn.keras.models.ROI4.model5 import build_model
from cnn.keras.optimizers import load_config, MySGD
from cnn.keras.ROI.image_processing import inputs
...
num_val_samples = 452
# Paths
path_ADNI = '/home/mhubrich/ADNI_intnorm_ROI4'
path_checkpoints = '/home/mhubrich/checkpoints/adni/metaROI4_5'
path_weights = None
