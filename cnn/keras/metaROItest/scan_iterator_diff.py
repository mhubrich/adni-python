...
class ScanIterator(Iterator):
    ...
    def next(self):
        ...
        diff_1 = np.zeros((current_batch_size,) + (1,))
        diff_2 = np.zeros((current_batch_size,) + (1,))
        diff_3 = np.zeros((current_batch_size,) + (1,))
        diff_4 = np.zeros((current_batch_size,) + (1,))
        diff_5 = np.zeros((current_batch_size,) + (1,))
