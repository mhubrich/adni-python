...
# Change both paths
directory = '/home/mhubrich/ADNI_intnorm_deepROI2_NC'
brain = np.load('/home/mhubrich/predicted_brain_NC_pn_threshold_005.npy')
...
for f in files:
    ...
    scan *= brain
    # Keep only important region (new dims: 80x80x80)
    scan = scan[9:89,:,:][:,11:91,:][:,:,4:84]
    # Pool down by 4x4x4 (new dims: 20x20x20)
