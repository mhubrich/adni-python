...
from cnn.keras.utils.filename_iterator_partitioned import FilenameIteratorPartitioned


class FilenameGeneratorPartitioned(ImageDataGenerator):
    def flow_from_directory(self, scans, grid,
                            target_size=(30, 30, 30), load_all_scans=True,
                            classes=None, batch_size=32):
        return FilenameIteratorPartitioned(
