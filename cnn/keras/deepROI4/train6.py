...
path_checkpoints = '/home/mhubrich/checkpoints/adni/deepROI4_6'
...
def train():
    ...
    scans_train = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_mean2/deepROI_fold1/6_train')
    x_train, y_train = load_data(scans_train, flip=True)

    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_mean2/deepROI_fold1/6_val')
