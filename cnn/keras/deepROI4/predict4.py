...
load_all_scans = True
# Paths
path_ADNI = '/home/mhubrich/ADNI_intnorm_deepROI4_4'
path_model = '/home/mhubrich/checkpoints/adni/deepROI4_4/model.0186-loss_0.278-acc_0.975-val_loss_nan-val_acc_0.9104-val_fmeasure_0.8868-val_mcc_0.8145-val_mean_acc_0.9126.h5'
...
def predict():
    ...
    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_mean2/deepROI_fold1/4_test')
    ...
    with open('predictions_deepROI4_4_fliter_' + str(filter_length) + '.csv', 'wb') as csvfile:
