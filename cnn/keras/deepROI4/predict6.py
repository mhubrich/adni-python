...
load_all_scans = True
# Paths
path_ADNI = '/home/mhubrich/ADNI_intnorm_deepROI4_6'
path_model = '/home/mhubrich/checkpoints/adni/deepROI4_6/model.0163-loss_0.250-acc_0.979-val_loss_nan-val_acc_0.9712-val_fmeasure_0.9688-val_mcc_0.9425-val_mean_acc_0.9702.h5'
...
def predict():
    ...
    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_mean2/deepROI_fold1/6_test')
    ...
    with open('predictions_deepROI4_6_fliter_' + str(filter_length) + '.csv', 'wb') as csvfile:
