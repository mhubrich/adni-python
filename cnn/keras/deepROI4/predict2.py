...
load_all_scans = True
# Paths
path_ADNI = '/home/mhubrich/ADNI_intnorm_deepROI4_2'
path_model = '/home/mhubrich/checkpoints/adni/deepROI4_2/model.0077-loss_0.368-acc_0.941-val_loss_0.3846-val_acc_0.8943-val_fmeasure_0.8738-val_mcc_0.7840-val_mean_acc_0.8952.h5'
...
def predict():
    ...
    with open('predictions_deepROI4_2_fliter_' + str(filter_length) + '.csv', 'wb') as csvfile:
