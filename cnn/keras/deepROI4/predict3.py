...
load_all_scans = True
# Paths
path_ADNI = '/home/mhubrich/ADNI_intnorm_deepROI4_3'
path_model = '/home/mhubrich/checkpoints/adni/deepROI4_3/model.0082-loss_0.393-acc_0.936-val_loss_0.2838-val_acc_0.9127-val_fmeasure_0.8952-val_mcc_0.8303-val_mean_acc_0.9255.h5'
...
def predict():
    ...
    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_mean2/deepROI_fold1/3_test')
    ...
    with open('predictions_deepROI4_3_fliter_' + str(filter_length) + '.csv', 'wb') as csvfile:
