...
path_checkpoints = '/home/mhubrich/checkpoints/adni/final_deepROI2_CNN_pSMC_CV' + fold
...
def train():
    ...
    scans_train = read_imageID(path_ADNI, '/home/mhubrich/final_deepROI2/' + fold + '_train_CNN')
