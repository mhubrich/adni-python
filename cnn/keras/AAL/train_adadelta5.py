...
path_checkpoints = '/home/mhubrich/checkpoints/adni/adadelta_test5_CV' + fold
path_weights = None
...
def train():
    ...
    if path_weights is None:
        model = build_model(1)
        adadelta = Adadelta(lr=0.15, decay=0.001)
    ...
    cbks = [callbacks.print_history(),
            callbacks.flush(),
            callbacks.early_stop(patience=250, monitor=['val_loss', 'val_acc', 'val_matthews_correlation']),
