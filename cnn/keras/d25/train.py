...
from cnn.keras.models.vgg16_d25.model import build_model
from cnn.keras.optimizers import load_config, MySGD
from cnn.keras.d25.preprocessing.image_processing import inputs
...
def train():
    ...
    train_inputs = inputs(scans_train, batch_size, classes, 'train', SEED)
    val_inputs = inputs(scans_val, batch_size, classes, 'val', SEED)
