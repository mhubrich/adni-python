...
from cnn.keras.models.d3F.model import build_model
...
import sys
sys.stdout = sys.stderr = open('outputF_2', 'w')


# Training specific parameters
target_size = (11, 11, 11)
FRACTION_TRAIN = 0.8
...
path_checkpoints = '/home/mhubrich/checkpoints/adni/slices_F_2'
path_weights = None
