from cnn.keras.slices.preprocessing.scan_data_generator import ScanDataGenerator
from cnn.keras.slices.preprocessing.predict_generator import PredictGenerator
