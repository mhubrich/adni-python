...
from cnn.keras.models.AVG444.model_FAQ_input import build_model
from cnn.keras.full_FAQ_input.image_processing import inputs
...
path_checkpoints = '/home/mhubrich/checkpoints/adni/full_FAQ_input_2_CV' + fold
path_weights = None
