...
from cnn.keras.models.metaROI3.auto_model1 import build_model
from cnn.keras.optimizers import load_config, MySGD
from cnn.keras.metaROI_autoencoder.metaROI3.preprocessing.image_processing import inputs
...
num_val_samples = 451
# Paths
path_ADNI = '/home/mhubrich/ADNI_intnorm_metaROI3'
path_checkpoints = '/home/mhubrich/checkpoints/adni/metaROI3_auto1_1'
path_weights = None
