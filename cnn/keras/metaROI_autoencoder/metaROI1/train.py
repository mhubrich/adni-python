...
from cnn.keras.models.metaROI1.auto_model1 import build_model
from cnn.keras.optimizers import load_config, MySGD
from cnn.keras.metaROI_autoencoder.metaROI1.preprocessing.image_processing import inputs
...
path_checkpoints = '/home/mhubrich/checkpoints/adni/metaROI_auto1_2'
path_weights = None
