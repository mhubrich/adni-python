...
from cnn.keras.models.metaROI2.auto_model1 import build_model
from cnn.keras.optimizers import load_config, MySGD
from cnn.keras.metaROI_autoencoder.metaROI2.preprocessing.image_processing import inputs
...
path_checkpoints = '/home/mhubrich/checkpoints/adni/metaROI2_auto1_1'
path_weights = None
