...
from cnn.keras.models.meanROI1_2.model_single1 import build_model
...
target_size = (23, 23, 23)
classes = ['Normal', 'AD']
batch_size = 32
load_all_scans = False
num_epoch = 750
# Paths
path_ADNI = '/home/mhubrich/ADNI_intnorm_meanROI1_2'
path_checkpoints = '/home/mhubrich/checkpoints/adni/meanROI1_2_pretrained_82_2_rui'
path_weights = None
