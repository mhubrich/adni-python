...
path_importanceMap = None  # '/home/mhubrich/adni-python/cnn/keras/deepROI6/importanceMap'
path_model = '/home/mhubrich/checkpoints/adni/deepROI6_1/model.0555-loss_0.503-acc_0.903-val_loss_0.2121-val_acc_0.9298-val_fmeasure_0.9149-val_mcc_0.8649-val_mean_acc_0.9437.h5'


def predict():
    # Get inputs for training and validation
    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_mean2/deepROI_fold1/1_test')
    ...
    with open('predictions_deepROI6_1_fliter_' + str(filter_length) + '.csv', 'wb') as csvfile:
