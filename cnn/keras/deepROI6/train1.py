...
path_checkpoints = '/home/mhubrich/checkpoints/adni/deepROI6_1'
...
def train():
    ...
    scans_train = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_mean2/deepROI_fold1/1_train')
    x_train, y_train = load_data(scans_train)

    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_mean2/deepROI_fold1/1_val')
