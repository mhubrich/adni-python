...
from cnn.keras.full_age_output.image_processing import inputs
...
path_checkpoints = '/home/mhubrich/checkpoints/adni/full_age_output_1_CV' + fold
path_weights = None
...
def train():
    ...
    if path_weights is None:
        ...
        model.compile(loss=['binary_crossentropy', 'mse'], optimizer=sgd, metrics=['accuracy'])
    else:
