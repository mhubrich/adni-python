...
from cnn.keras.models.metaROI2.model3 import build_model
from cnn.keras.optimizers import load_config, MySGD
from cnn.keras.metaROI2.image_processing import inputs
...
path_checkpoints = '/home/mhubrich/checkpoints/adni/metaROI2_3'
path_weights = None
