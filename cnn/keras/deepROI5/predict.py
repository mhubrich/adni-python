...
path_model = '/home/mhubrich/checkpoints/adni/deepROI4_1/model.0150-loss_0.336-acc_0.956-val_loss_0.3506-val_acc_0.9211-val_fmeasure_0.9126-val_mcc_0.8408-val_mean_acc_0.9197.h5'
...
def predict():
    ...
    with open('predictions_deepROI4_1_fliter_' + str(filter_length) + '.csv', 'wb') as csvfile:
