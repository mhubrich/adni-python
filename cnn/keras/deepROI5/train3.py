...
num_epoch = 1000
# Paths
path_ADNI = '/home/mhubrich/ADNI_intnorm_deepROI5_3'
path_checkpoints = '/home/mhubrich/checkpoints/adni/deepROI5_3'
...
def train():
    ...
    scans_train = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_mean2/deepROI_fold1/3_train')
    x_train, y_train = load_data(scans_train, flip=True)

    scans_val = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_mean2/deepROI_fold1/3_val')
