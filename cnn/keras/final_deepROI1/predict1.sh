...
THEANO_FLAGS=device=gpu,floatX=float32 python predict1.py 1 1
THEANO_FLAGS=device=gpu,floatX=float32 python predict1.py 1 2
THEANO_FLAGS=device=gpu,floatX=float32 python predict1.py 1 3
THEANO_FLAGS=device=gpu,floatX=float32 python predict1.py 1 4
THEANO_FLAGS=device=gpu,floatX=float32 python predict1.py 1 5
THEANO_FLAGS=device=gpu,floatX=float32 python predict1.py 1 6
THEANO_FLAGS=device=gpu,floatX=float32 python predict1.py 1 7
THEANO_FLAGS=device=gpu,floatX=float32 python predict1.py 1 8
THEANO_FLAGS=device=gpu,floatX=float32 python predict1.py 1 9
THEANO_FLAGS=device=gpu,floatX=float32 python predict1.py 1 10
