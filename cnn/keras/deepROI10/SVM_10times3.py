...
for i in range(1, 11):
    for fold in range(1, 11):
        ...
        for c in range(len(C)):
                ...
                selector = RFE(clf, n_features_to_select=500, step=0.005)
...
np.save('SVM/metrics_val_deepROI10_' + pre + '_00001_135_full3_10times.npy', metrics_val)
np.save('SVM/metrics_test_deepROI10_' + pre + '_00001_135_full3_10times.npy', metrics_test)
