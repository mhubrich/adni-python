...
np.save('SVM/metrics_val_deepROI10_' + pre + '_00000003_135_stnd_LOO.npy', metrics_val)
np.save('SVM/metrics_test_deepROI10_' + pre + '_00000003_135_stnd_LOO.npy', metrics_test)
np.save('SVM/metrics_labels_deepROI10_' + pre + '_00000003_135_stnd_LOO.npy', labels)
