...
def predict():
    scans_cnn = read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_deepROI10/' + fold2 + '_train')
    scans_cnn += read_imageID(path_ADNI, '/home/mhubrich/ADNI_CV_deepROI10/' + fold2 + '_val')
    ...
    with open('predictions/predictions_deepROI10_2_fliter_' + str(filter_length) + '_fold_' + fold + '_' + fold2 + '_stnd.csv', 'wb') as csvfile:
